...
export const CHARACTERS: Character[] = [
  { id: "baker", emoji: "🍞", title: "the Baker", blurb: "Everyone loves the buns. Gerald did too.", image: "/characters/baker.jpg", icon: "/characters/baker-icon.png" },
  ...
  { id: "drunk", emoji: "🍺", title: "the Drunk", blurb: "Remembers the murder. Misplaced the trousers.", image: "/characters/drunk.jpg", icon: "/characters/drunk-icon.png" },
