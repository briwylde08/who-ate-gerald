      ...
      <div className="panel lobby">
        ...
        {view.winner && view.bear && (
          <div className="answer-card" style={{ fontSize: "1.1rem" }}>
            ...
            {/* The takings ledger came OFF the reckoning card (Bri,
                2026-08-18) — the server still computes takings for anyone
                who asks the public view; the finale just doesn't read
                receipts out loud. */}
          </div>
        )}
